	...
	<div>
		<van-sticky>
			<form class="form" action="/">
				<van-search v-model="value" left-icon input-align="center" :placeholder="icon" background="#3296FA" shape="round"
		...
		methods: {
			...
			async getChannels() {
				...
				if (!user) {
					...
					let channels = JSON.stringify(window.localStorage.getItem("channels"));
					if (channels) {
